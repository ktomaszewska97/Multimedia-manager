    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(checkPermission()) {
                    ...
                    Toast.makeText(VoiceRecorder.this, "Recording started",
        ...
        buttonStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(VoiceRecorder.this, "Recording Completed",
                        Toast.LENGTH_LONG).show();
            }
        });
        ...
        buttonPlayLastRecordAudio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) throws IllegalArgumentException,
                ...
                mediaPlayer.start();
                Toast.makeText(VoiceRecorder.this, "Recording Playing",
                        Toast.LENGTH_LONG).show();
            }
        });
            ...
            case RequestPermissionCode:
                if (grantResults.length> 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        ...
                        Toast.makeText(VoiceRecorder.this,"PermissionDenied",Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
